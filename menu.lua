...
if type(Movement) ~= "table" then
    error("movement.lua did not return a module table! Check your GitHub file.")
end
...
statsSection:AddSlider({
    ...
    Callback = function(val)
        Movement:SetSpeed(Movement.SpeedEnabled, val)
    end
})
...
statsSection:AddSlider({
    ...
    Flag = "JumpPowerValue",
    Callback = function(val)
        Movement:SetJump(Movement.JumpEnabled, val)
    end
})
